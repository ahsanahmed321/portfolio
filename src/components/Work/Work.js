...
import shImage from "../../Images/SoftwareHouse.png";
          ...
          <Row style={{ paddingTop: "32px" }}>
            <Col sm={12} md={6}>
              <Card
                ...
                onClick={() =>
                  window.open("https://bookstore321.herokuapp.com/", "_blank")
                }
              >
                <CardTitle>Book Store</CardTitle>
                <CardImg width="100%" src={bsImage} height="350vh" />
                <CardText>
                  A Mern stack E-commerece Site with authentication and cart
                  system
                </CardText>
              </Card>
            </Col>
          ...
          <Row style={{ paddingTop: "32px" }}>
            <Col sm={12} md={6}>
              ...
              >
                ...
                <CardText>A Reactjs Front End Software House App</CardText>
              </Card>
            </Col>
            <Col sm={12} md={6}>
              <Card
              ...
              >
                ...
                <CardText>A Reactjs To do list Built with react hooks</CardText>
              </Card>
            </Col>
          </Row>
        </Container>
